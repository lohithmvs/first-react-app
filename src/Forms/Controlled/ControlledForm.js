...
const ControlledForm = () => {
  ...
  const DeleteName=(ind)=>{
    const ls=list1.filter((_,index)=>{
        return (index!==ind)
    })
    updateList(ls)
  }
        ...
        <>
          <form onSubmit={SubmitHandler} style={{ maxWidth: "800px" }}>
            ...
            {userError && (
              <span style={{ color: "red" }}>
                enter the username less than 15 characters
              </span>
            )}
            <div className="mb-3">
            ...
            {passError && (
              <span style={{ color: "red" }}>
                enter the password less than 15 characters
              </span>
            )}
            <div>
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              ...
              <tr>
                <td>{val}</td>
                <td><button onClick={()=>DeleteName(index)}>Delete</button></td>
                </tr>  
              </>
            ))}
            </tbody>
